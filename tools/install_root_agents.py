...
def render_bridge(*, target_root: Path, ai_brain_root: Path, data_root: Path | None = None) -> str:
    ...
    return "\n".join(
        [
            ...
            "",
            "Conservative AI Brain subagent policy:",
            "",
            "- Routed roles and selected specialists are review lenses, not",
            "  automatic spawn instructions. Use up to four children only for",
            "  genuinely independent work with disjoint write scopes and a",
            "  concrete parallelism or review benefit.",
            ...
            "  deterministic checks, and alone can declare completion.",
            "",
